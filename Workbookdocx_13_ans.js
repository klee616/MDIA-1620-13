...
/**
 * @description The function use for fromat a sentence .
 * @param {String} optionOne - Aame of option one
 * @param {int} numberOfOptionOne - The number of option one.
 * @param {String} optionTwo - Name of option two
 * @param {int} numberOfOptionTwo - The number of option Two
 * @returns {String}
 */
...
{
    var total = numberOfOptionOne + numberOfOptionTwo;
    return `I have ${numberOfOptionOne} ${optionOne} and ${numberOfOptionTwo} ${optionTwo}. This gives me a total of ${total} chips.`;
...
var x = myFunction(5, 8);
console.log("The answer is %d.", x); // The answer is 40.;

/**
 * @Description the function is calculate the numberOne times numberTwo.
 * @param {int} numberOne 
 * @param {int} numberTwo 
 * @returns {int} the number that is numberOne times numberTwo.
 */
...
/**
 * @description The function calculate the amount = quanitiy * price
 * @param {int} quanitiy 
 * @param {int} price 
 * @returns {int} 
 */
function myShoppingList(quanitiy, price){
    return quanitiy * price;
}
console.log("The amount is %d.", shopping); // The amount is 48.
...
var x = myFunction(5, 6); // The function was created in 13-2-0

console.log('The x is %d', x); // The is is 30;

var d = 5;
var z = addingFive(x, d);

console.log("The z is %d.", z); //The z is 35.
/**
 * @description The function return the value G + H.
 * @param {int} g 
 * @param {int} h 
 * @returns {int}
 */
 ...
 */
var microsoft = question15_5();

console.dir(microsoft);
console.log(microsoft.processor);


function question15_5(){
    microsoft = {
        laptop : "Surface Laptop 4",
        screenInches : 14.3,
        memoryGB : 16,
        batteryLife : 19,
        processor : "Quad Core 11th Intel Core i7-1185G7 processor",
    };
    return microsoft;
}
 ...
 * @param {String} name 
 * @param {int} age 
 * @returns {String} return My name is _name_ and I am _age_ years old.
 */
function sentenceFunction(name , age){
    return `My name is ${name} and I am ${age} years old.`;
}

var personOne = sentenceFunction('George', 25);
...
var personOne = sentenceFunction(firstName, 25); // The function was created in 13_2_6 
...
info(number); // You did not guess correctly
...
function sentence(activity, location){
    if(activity == "gardening"){
        ...
        console.log(`I live in ${location} and I like ${activity}.`);
    }else{
...
function findGrade(name, marks){
    if(marks > 85 && marks <= 100){
        ...
        console.log(`Invalied mark of ${marks}.`);
    }
}

findGrade("Sarah", 91); //Sarah you got an A.
findGrade("George", 85); //George you got a B.
findGrade("Sam", 73);  // Sam you got a B.
findGrade("Emily", 53); // Emily you got a C.
findGrade("Tom", 20); // Tom you got failed.
findGrade("Wilson", 120); // Invalied mark of 120.
...
function evaluateNumbers(num1, num2, operation){
    var result;
    if(operation == "add"){
        result = num1 + num2;
...
evaluateNumbers(15, 10, "add");  // Sum of 15 and 10 is 25.
evaluateNumbers(20, 8, "subtract"); // Difference of 20 and 8 is 12.
evaluateNumbers(12, 4, "multipy"); // Product of 12 and 4  is 48.
evaluateNumbers(28, 7, "divide"); // Division of 28 and 7 is 4.
evaluateNumbers(22, 3, "modulus"); // Modulus of 22 and 3 is 1.
evaluateNumbers(31, 3, "square");  //square is an invalid operation
